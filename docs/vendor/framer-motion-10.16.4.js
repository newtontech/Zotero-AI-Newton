!(function (t, e) {
  ...
  const o = e.createContext({
    ...
    u = c ? e.useLayoutEffect : e.useEffect,
  ...
  function C({
    ...
    const p = e.forwardRef(function (p, f) {
      let g;
      const y = { ...e.useContext(o), ...p, layoutId: V(p) },
        { isStatic: v } = y,
        P = x(p),
        w = r(p, v);
      if (!v && c) {
        P.visualElement = (function (t, n, s, i) {
          const { visualElement: r } = e.useContext(a),
            c = e.useContext(h),
            d = e.useContext(l),
            m = e.useContext(o).reducedMotion,
            p = e.useRef();
          ((i = i || c.renderer),
            !p.current &&
              i &&
  ...
  const W = (t) => (e) => "string" == typeof e && e.startsWith(t),
    z = W("--"),
    H = W("var(--"),
  ...
  function ct(t, e, n, s) {
    ...
    for (const t in e) {
      ...
      if (j.has(t)) {
        ...
        n !== (s.default || 0) && (u = !1);
      } else t.startsWith("origin") ? ((c = !0), (a[t] = h)) : (i[t] = h);
    }
    if (
      (e.transform ||
        (l || s
          ? (i.transform = N(t.transform, n, u, s))
      ...
      Object.assign(
        ...
        (function ({ transformTemplate: t }, n, s) {
          return e.useMemo(() => {
            ...
            return (
              ct(e, n, { enableHardwareAcceleration: !s }, t),
  ...
  function Tt(t, n, s, i) {
    ...
    if (t.style) {
      const e = {};
      (ht(e, t.style, t), (r.style = { ...e, ...r.style }));
    }
    return r;
  }
  function At(t = !1) {
    return (n, s, i, { latestValues: r }, o) => {
      const a = (R(n) ? Tt : mt)(s, r, o, n),
        l = { ...vt(s, "string" == typeof n, t), ...a, ref: i },
        { children: c } = s,
        u = e.useMemo(() => (O(c) ? c.get() : c), [c]);
      return e.createElement(n, { ...l, children: u });
    };
  }
  ...
  function Ft(t) {
    ...
    return (
      (n = e),
      n && "object" == typeof n && n.mix && n.toValue ? e.toValue() : e
    );
    var n;
  }
  const Ot = (t) => (n, s) => {
    const i = e.useContext(a),
      ...
      o = () =>
        (function (
          ...
          const o = { latestValues: It(s, i, r, t), renderState: e() };
          return (n && (o.mount = (t) => n(s, t, o)), o);
        })(t, n, i, r);
    return s ? o() : Bt(o);
  };
  function It(t, e, n, s) {
    ...
    if (h && "boolean" != typeof h && !p(h)) {
      (Array.isArray(h) ? h : [h]).forEach((e) => {
        const n = kt(t, e);
        if (!n) return;
        const { transitionEnd: s, transition: r, ...o } = n;
        for (const t in o) {
          let e = o[t];
          if (Array.isArray(e)) {
            e = e[u ? e.length - 1 : 0];
  ...
  const {
      ...
      return {
        ...
        cancel: (t) => Wt.forEach((e) => r[e].cancel(t)),
        state: i,
        steps: r,
      };
    })(
  ...
  function qt(t, { forwardMotionProps: e = !1 }, n, s) {
    return {
      ...(R(t) ? Xt : Gt),
      preloadedFeatures: n,
      useRender: At(e),
  ...
  const Jt = (t) => (e) => Kt(e) && t(e, _t(e));
  function Qt(t, e, n, s) {
    return Zt(t, e, Jt(n), s);
  }
  ...
  function fe(t, e, n) {
    const s = (function ({ root: t, ...e }) {
      ...
      const s = de.get(n),
        i = JSON.stringify(e);
      return (
        s[i] || (s[i] = new IntersectionObserver(pe, { root: t, ...e })),
        s[i]
      );
    })(e);
    return (
        ...
        startObserver() {
          ...
          const { viewport: t = {} } = this.node.getProps(),
            ...
            r = {
              ...
              rootMargin: n,
              threshold: "number" == typeof s ? s : ge[s],
            };
          return fe(this.node.current, r, (t) => {
      ...
      Feature: class extends ae {
        constructor() {
          (super(...arguments),
            ...
            (this.startPointerPress = (t, e) => {
              ...
              ((this.removeEndListeners = ee(s, i)), this.startPress(t, e));
            }),
            (this.startAccessiblePress = () => {
              const t = Zt(this.node.current, "keydown", (t) => {
                  if ("Enter" !== t.key || this.isPressing) return;
                  (this.removeEndListeners(),
                    (this.removeEndListeners = Zt(
                      this.node.current,
                      "keyup",
                      (t) => {
                        "Enter" === t.key &&
        ...
        mount() {
          const t = this.node.getProps(),
            e = Qt(this.node.current, "pointerdown", this.startPointerPress, {
              passive: !(t.onTapStart || t.onPointerStart),
            }),
            n = Zt(this.node.current, "focus", this.startAccessiblePress);
  ...
  const Pe = "data-" + Ct("framerAppearId");
  let we = Ut,
    Ee = Ut;
  const be = (t) => 1e3 * t,
    Se = (t) => t / 1e3,
  ...
  function Ce(t) {
    return Boolean(
      !t ||
        ...
        Ae(t) ||
        (Array.isArray(t) && t.every(Ce)),
    );
  }
  const Ve = ([t, e, n, s]) => `cubic-bezier(${t}, ${e}, ${n}, ${s})`,
    Me = {
      linear: "linear",
      ease: "ease",
      easeIn: "ease-in",
  ...
  function De(t) {
    if (t) return Ae(t) ? Ve(t) : Array.isArray(t) ? t.map(De) : Me[t];
  }
  function Re(
    t,
    e,
  ...
  const Be = ke(0.42, 0, 1, 1),
    je = ke(0, 0, 0.58, 1),
    Fe = ke(0.42, 0, 0.58, 1),
    Oe = (t) => Array.isArray(t) && "number" != typeof t[0],
    Ie = (t) => (e) => (e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2),
    Ue = (t) => (e) => 1 - t(1 - e),
    Ne = (t) => 1 - Math.sin(Math.acos(t)),
    We = Ue(Ne),
    ze = Ie(We),
    He = ke(0.33, 1.53, 0.69, 0.99),
    $e = Ue(He),
    Ye = Ie($e),
    Xe = (t) =>
    ...
    qe = (t) => {
      ...
      return "string" == typeof t ? (Ee(void 0 !== Ge[t]), Ge[t]) : t;
    },
    Ze = (t, e) => (n) =>
      Boolean(
    ...
    _e = { ...X, transform: (t) => Math.round(((t) => Y(0, 255, t))(t)) },
    Je = {
      test: Ze("rgb", "red"),
  ...
  const Qe = {
    ...
    en = {
      ...
      parse: (t) =>
        Je.test(t) ? Je.parse(t) : tn.test(t) ? tn.parse(t) : Qe.parse(t),
      transform: (t) =>
        Q(t) ? t : t.hasOwnProperty("red") ? Je.transform(t) : tn.transform(t),
    },
    nn = (t, e, n) => -n * t + n * e + t;
  function sn(t, e, n) {
    return (
  ...
  const ln = (t, e) => {
    const n = an(t),
      ...
      i = { ...n };
    return (t) => (
      (i.red = rn(n.red, s.red, t)),
      (i.green = rn(n.green, s.green, t)),
      (i.blue = rn(n.blue, s.blue, t)),
      (i.alpha = nn(n.alpha, s.alpha, t)),
      Je.transform(i)
    );
  };
  const cn = {
    ...
    un = { regex: _, countKey: "Colors", token: "${c}", parse: en.parse },
    hn = { regex: K, countKey: "Numbers", token: "${n}", parse: X.parse };
  function dn(t, { regex: e, countKey: n, token: s, parse: i }) {
  ...
  function fn(t) {
    const { values: e, numColors: n, numVars: s, tokenised: i } = mn(t),
      r = e.length;
    return (t) => {
      let e = i;
      for (let i = 0; i < r; i++)
        e =
          i < s
            ? e.replace(cn.token, t[i])
            : i < s + n
              ? e.replace(un.token, en.transform(t[i]))
              : e.replace(hn.token, Z(t[i]));
      return e;
    };
  }
  ...
  const Pn = (t, e) => {
    ...
    wn = (t, e) => {
      const n = { ...t, ...e },
        s = {};
      for (const i in n)
        void 0 !== t[i] && void 0 !== e[i] && (s[i] = xn(t[i], e[i]));
      return (t) => {
  ...
  function An(t, e, { clamp: n = !0, ease: s, mixer: i } = {}) {
    const r = t.length;
    if ((Ee(r === e.length), 1 === r)) return () => e[0];
    ...
    const o = Tn(e, s, i),
      ...
      l = (e) => {
        ...
        const s = bn(t[n], t[n + 1], e);
        return o[n](s);
      };
    return n ? (e) => l(Y(t[0], t[r - 1], e)) : l;
  }
  function Cn(t, e) {
  ...
  function Mn({
    ...
    const i = Oe(s) ? s.map(qe) : qe(s),
      r = { done: !1, value: e[0] },
      o = An(
        (function (t, e) {
          return t.map((t) => t * e);
        })(n && n.length === e.length ? n : Vn(e), t),
        e,
        {
          ease: Array.isArray(i)
            ? i
            : ((a = e), (l = i), a.map(() => l || Fe).splice(0, a.length - 1)),
        },
      );
    var a, l;
    return {
    ...
    ((o = Y(0.05, 1, o)),
      ...
      o < 1
        ? ((i = (e) => {
            const s = e * o,
              i = s * t;
            return 0.001 - ((s - n) / kn(e, o)) * Math.exp(-i);
          }),
          (r = (e) => {
            const s = e * o * t,
              r = s * n + n,
              ...
              l = Math.exp(-s),
              c = kn(Math.pow(e, 2), o);
            return ((0.001 - i(e) > 0 ? -1 : 1) * ((r - a) * l)) / c;
          }))
  ...
  function On({ keyframes: t, restDelta: e, restSpeed: n, ...s }) {
    const i = t[0],
      r = t[t.length - 1],
      o = { done: !1, value: i },
      {
    ...
    if ((n || (n = y ? 0.01 : 2), e || (e = y ? 0.005 : 0.5), p < 1)) {
    ...
    } else if (1 === p) v = (t) => r - Math.exp(-g * t) * (f + (m + g * f) * t);
    else {
      ...
      v = (e) => {
        const n = Math.exp(-p * g * e),
          s = Math.min(t * e, 300);
        return (
          r - (n * ((m + p * g * f) * Math.sinh(s) + t * f * Math.cosh(s))) / t
        );
      };
    }
    return {
  ...
  const Un = (t) => {
    ...
    return {
      start: () => zt.update(e, !0),
      stop: () => Ht(e),
      now: () => ($t.isProcessing ? $t.timestamp : performance.now()),
    };
  };
  function Nn(t) {
    let e = 0;
  ...
  const Wn = { decay: In, inertia: In, tween: Mn, keyframes: Mn, spring: On };
  function zn({
    autoplay: t = !0,
    delay: e = 0,
    driver: n = Un,
    ...
    let b = "idle",
      ...
      T = null,
      A = null;
    null === w.calculatedDuration && r && (w.calculatedDuration = Nn(w));
    const { calculatedDuration: C } = w;
    let V = 1 / 0,
      M = 1 / 0;
    null !== C && ((V = C + o), (M = V * (r + 1) - o));
    let D = 0;
    const R = (t) => {
        if (null === T) return;
        (f > 0 && (T = Math.min(T, t)),
          f < 0 && (T = Math.min(t - M / f, T)),
          (D = null !== S ? S : Math.round(t - T) * f));
        const n = D - e * (f >= 0 ? 1 : -1),
          i = f >= 0 ? n < 0 : n > M;
        ...
        const u = i ? { done: !1, value: s[0] } : c.next(l);
        P && (u.value = P(u.value));
        let { done: d } = u;
        i || null === C || (d = f >= 0 ? D >= M : D <= 0);
        const m = null === S && ("finished" === b || ("running" === b && d));
        return (h && h(u.value), m && B(), u);
      },
      L = () => {
        (v && v.stop(), (v = void 0));
      },
      k = () => {
        ((b = "idle"), L(), m(), y(), (T = A = null));
      },
      B = () => {
        ((b = "finished"), u && u(), L(), m());
      },
    ...
    const F = {
      ...
      set time(t) {
        ((t = be(t)),
          (D = t),
          null === S && v && 0 !== f ? (T = v.now() - t / f) : (S = t));
      },
      get duration() {
        const t = null === w.calculatedDuration ? Nn(w) : w.calculatedDuration;
        return Se(t);
      },
      get speed() {
        return f;
  ...
  const $n = Hn(() => Object.hasOwnProperty.call(Element.prototype, "animate")),
    Yn = new Set([
      "opacity",
      "clipPath",
      "filter",
  ...
  function Xn(t, e, { onUpdate: n, onComplete: s, ...i }) {
    if (
      !(
        $n() &&
        Yn.has(e) &&
    ...
    l();
    let { keyframes: c, duration: u = 300, ease: h, times: d } = i;
    if (
      ((t, e) => "spring" === e.type || "backgroundColor" === t || !Ce(e.ease))(
        e,
        i,
      )
    ) {
      const t = zn({ ...i, repeat: 0, delay: 0 });
      let e = { done: !1, value: c[0] };
      const n = [];
      let s = 0;
      for (; !e.done && s < 2e4; )
    ...
    const m = Re(t.owner.current, e, c, {
      ...i,
      duration: u,
      ease: h,
      times: d,
  ...
  const ls =
    ...
    (i) => {
      ...
      const l = (function (t, e, n, s) {
          ...
          const o = void 0 !== s.from ? s.from : t.get();
          let a = void 0;
          const l = [];
      ...
      if (
        ...
        m.duration && (m.duration = be(m.duration)),
        m.repeatDelay && (m.repeatDelay = be(m.repeatDelay)),
        ...
        return (function ({
          ...
          return e
            ? zn({ keyframes: [0, 1], duration: 0, delay: e, onComplete: i })
            : i();
        })(Te.current ? { ...m, delay: 0 } : m);
      if (
        e.owner &&
  ...
  class ms {
    ...
    add(t) {
      return (hs(this.subscriptions, t), () => ds(this.subscriptions, t));
    }
    notify(t, e, n) {
  ...
  class fs {
    constructor(t, e = {}) {
      ...
      ((this.version = "10.16.4"),
        ...
        (this.updateAndNotify = (t, e = !0) => {
          ...
          const { delta: n, timestamp: s } = $t;
          (this.lastUpdated !== s &&
            ((this.timeDelta = n),
            (this.lastUpdated = s),
            zt.postRender(this.scheduleVelocityCheck)),
        ...
        (this.scheduleVelocityCheck = () => zt.postRender(this.velocityCheck)),
    ...
    on(t, e) {
      this.events[t] || (this.events[t] = new ms());
    ...
    getVelocity() {
      return this.canTrackVelocity
        ? Dn(parseFloat(this.current) - parseFloat(this.prev), this.timeDelta)
        : 0;
    }
    start(t) {
      return (
  ...
  function Es(t, e) {
    ...
    r = { ...r, ...s };
    for (const e in r) {
      ws(t, e, ((o = r[e]), jt(o) ? o[o.length - 1] || 0 : o));
    }
    var o;
  }
  function bs(t, e) {
        ...
        (Array.isArray(c) && (u = c[0]),
          null === u &&
            (u =
              null !==
                (i =
                  null !== (s = n[o]) && void 0 !== s ? s : t.readValue(o)) &&
              void 0 !== i
                ? i
                : e[o]),
          null != u &&
            ("string" == typeof u && (us(u) || rs(u))
              ? (u = parseFloat(u))
              : ((a = u), !Ps.find(ys(a)) && yn.test(c) && (u = is(o, c))),
            t.addValue(o, gs(u, { owner: t })),
            void 0 === n[o] && (n[o] = u),
  ...
  function Vs(t, e, { delay: n = 0, transitionOverride: s, type: i } = {}) {
    ...
    for (const e in a) {
      const s = t.getValue(e),
        i = a[e];
      if (!s || void 0 === i || (u && Cs(u, e))) continue;
      const o = { delay: n, elapsed: 0, ...r };
      if (window.HandoffAppearAnimations && !s.hasAnimated) {
        const n = t.getProps()[Pe];
        n &&
          ((o.elapsed = window.HandoffAppearAnimations(n, e, s, zt)),
          (o.syncStart = !0));
      }
      s.start(ls(e, s, i, t.shouldReduceMotion && j.has(e) ? { type: !1 } : o));
      const h = s.animation;
      (cs(l) && (l.add(e), h.then(() => l.remove(e))), c.push(h));
    }
    return (
      o &&
        Promise.all(c).then(() => {
      ...
      o =
        t.variantChildren && t.variantChildren.size
          ? (s = 0) => {
              ...
              return (function (t, e, n = 0, s = 0, i = 1, r) {
                const o = [],
  ...
  function Rs(t, e, n = {}) {
    ...
    if ((t.notify("AnimationStart", e), Array.isArray(e))) {
      const i = e.map((e) => Ms(t, e, n));
      s = Promise.all(i);
    } else if ("string" == typeof e) s = Ms(t, e, n);
    else {
      const i = "function" == typeof e ? xe(t, e, n.custom) : e;
  ...
  function Bs(t) {
    let e = (function (t) {
      return (e) =>
        Promise.all(e.map(({ animation: e, options: n }) => Rs(t, e, n)));
    })(t);
    const n = {
      animate: Fs(!0),
      whileInView: Fs(),
    ...
    function r(r, o) {
      ...
      for (let e = 0; e < ks; e++) {
        ...
        if (
          ...
          continue;
        const w = js(g.prevProp, y);
        let E = w || (f === o && g.isActive && !P && v) || (e > d && v);
        const b = Array.isArray(y) ? y : [y];
        let S = b.reduce(i, {});
        !1 === x && (S = {});
        const { prevResolvedValues: T = {} } = g,
          A = { ...T, ...S },
          C = (t) => {
            ((E = !0), u.delete(t), (g.needsAnimating[t] = !0));
          };
        for (const t in A) {
          const e = S[t],
            n = T[t];
        ...
        ((g.prevProp = y),
          ...
          E &&
            !P &&
            c.push(
              ...b.map((t) => ({ animation: t, options: { type: f, ...r } })),
            ));
      }
      if (u.size) {
        const e = {};
  ...
  function js(t, e) {
    return "string" == typeof e ? e !== t : !!Array.isArray(e) && !ve(e, t);
  }
  function Fs(t = !1) {
    return {
      isActive: t,
    ...
    constructor(t, e, { transformPagePoint: n } = {}) {
      if (
        ...
        (this.updatePoint = () => {
          ...
          const t = $s(this.lastMoveEventInfo, this.history),
            e = null !== this.startEvent,
            n = Ns(t.offset, { x: 0, y: 0 }) >= 3;
          if (!e && !n) return;
          const { point: s } = t,
            { timestamp: i } = $t;
        ...
        (this.handlePointerMove = (t, e) => {
          ((this.lastMoveEvent = t),
            (this.lastMoveEventInfo = zs(e, this.transformPagePoint)),
      ...
      const s = zs(_t(t), this.transformPagePoint),
        { point: i } = s,
        { timestamp: r } = $t;
      this.history = [{ ...i, timestamp: r }];
      const { onSessionStart: o } = e;
      (o && o(t, $s(s, this.history)),
  ...
  function Gs(t, e) {
    ...
    let n = t.length - 1,
      s = null;
    const i = Xs(t);
    for (; n >= 0 && ((s = t[n]), !(i.timestamp - s.timestamp > be(e))); ) n--;
    if (!s) return { x: 0, y: 0 };
    const r = Se(i.timestamp - s.timestamp);
  ...
  function Ks(t, e, n, s = 0.5) {
    ((t.origin = s),
      ...
      (t.scale = qs(n) / qs(e)),
      (Zs(t.scale, 1, 1e-4) || isNaN(t.scale)) && (t.scale = 1),
      (t.translate = nn(n.min, n.max, t.origin) - t.originPoint),
      (Zs(t.translate) || isNaN(t.translate)) && (t.translate = 0));
  }
  function _s(t, e, n, s) {
  ...
  function ui({ scale: t, scaleX: e, scaleY: n }) {
    return !ci(t) || !ci(e) || !ci(n);
  }
  function hi(t) {
    return ui(t) || di(t) || t.z || t.rotate || t.rotateX || t.rotateY;
  }
  function di(t) {
  ...
  function fi(t, e, n, s, i) {
    return (void 0 !== i && (t = pi(t, i, s)), pi(t, n, s) + e);
  }
  function gi(t, e = 0, n = 1, s, i) {
    ((t.min = fi(t.min, e, n, s, i)), (t.max = fi(t.max, e, n, s, i)));
  }
  function yi(t, { x: e, y: n }) {
    (gi(t.x, e.translate, e.scale, e.originPoint),
      gi(t.y, n.translate, n.scale, n.originPoint));
  }
  function vi(t) {
  ...
  function Pi(t, e, [n, s, i]) {
    const r = void 0 !== e[i] ? e[i] : 0.5,
      o = nn(t.min, t.max, r);
    gi(t, e[n], e[s], o, e.scale);
  }
  const wi = ["x", "scaleX", "originX"],
    Ei = ["y", "scaleY", "originY"];
  function bi(t, e) {
    (Pi(t.x, e, wi), Pi(t.y, e, Ei));
  }
  function Si(t, e) {
    return li(
      (function (t, e) {
  ...
  class Ai {
    ...
    start(t, { snapToCursor: e = !1 } = {}) {
      ...
      this.panSession = new Ws(
        ...
        {
          onSessionStart: (t) => {
            (this.stopAnimation(), e && this.snapToCursor(_t(t, "page").point));
          },
          onStart: (t, e) => {
            const {
              drag: n,
              ...
              ai((t) => {
                ...
                if (nt.test(e)) {
                  ...
                  if (n && n.layout) {
                    ...
                    if (s) {
                      e = qs(s) * (parseFloat(e) / 100);
                    }
                  }
                }
                this.originPoint[t] = e;
              }),
              i && zt.update(() => i(t, e), !1, !0));
    ...
    updateAxis(t, e, n) {
      ...
      if (!n || !Ci(t, s, this.currentDirection)) return;
      const i = this.getAxisMotionValue(t);
      let r = this.originPoint[t] + n[t];
      (this.constraints &&
        this.constraints[t] &&
        (r = (function (t, { min: e, max: n }, s) {
          return (
            void 0 !== e && t < e
              ? (t = s ? nn(e, t, s.min) : Math.max(t, e))
              : void 0 !== n &&
                t > n &&
                (t = s ? nn(n, t, s.max) : Math.min(t, n)),
            t
          );
      ...
      (t && d(t)
        ...
        : (this.constraints =
            ...
            (function (t, { top: e, left: n, bottom: s, right: i }) {
              return { x: ei(t.x, n, i), y: ei(t.y, e, s) };
            })(n.layoutBox, t)),
        (this.elastic = (function (t = si) {
          return (
            !1 === t ? (t = 0) : !0 === t && (t = si),
            { x: ii(t, "left", "right"), y: ii(t, "top", "bottom") }
          );
        })(e)),
        s !== this.constraints &&
          n &&
    ...
    resolveRefConstraints() {
      ...
      const i = (function (t, e, n) {
        const s = Si(t, n),
          { scroll: i } = e;
        return (i && (xi(s.x, i.offset.x), xi(s.y, i.offset.y)), s);
      })(n, s.root, this.visualElement.getTransformPagePoint());
      let r = (function (t, e) {
        return { x: ni(t.x, e.x), y: ni(t.y, e.y) };
      ...
      if (e) {
        ...
        ((this.hasMutatedConstraints = !!t), t && (r = li(t)));
      }
      return r;
    }
    startAnimation(t) {
      const {
        ...
        a = this.constraints || {},
        l = ai((o) => {
          if (!Ci(o, e, this.currentDirection)) return;
          let l = (a && a[o]) || {};
          r && (l = { min: 0, max: 0 });
          const c = s ? 200 : 1e6,
            u = s ? 40 : 1e7,
    ...
    snapToCursor(t) {
      ai((e) => {
        ...
        if (!Ci(e, n, this.currentDirection)) return;
        const { projection: s } = this.visualElement,
          i = this.getAxisMotionValue(e);
        if (s && s.layout) {
          const { min: n, max: r } = s.layout.layoutBox[e];
          i.set(t[e] - nn(n, r, 0.5));
        }
      });
    }
    scalePositionWithinConstraints() {
      ...
      ai((t) => {
        ...
        if (e) {
          ...
          s[t] = (function (t, e) {
            ...
            return (
              i > s
                ? (n = bn(e.min, e.max - s, t.min))
                : s > i && (n = bn(t.min, t.max - i, e.min)),
              Y(0, 1, n)
            );
      ...
      ((this.visualElement.current.style.transform = i ? i({}, "") : "none"),
        ...
        this.resolveConstraints(),
        ai((e) => {
          if (!Ci(e, t, null)) return;
          const n = this.getAxisMotionValue(e),
            { min: i, max: r } = this.constraints[e];
          n.set(nn(i, r, s[e]));
        }));
    }
    addListeners() {
  ...
  const Mi = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"],
    Di = Mi.length,
    Ri = (t) => ("string" == typeof t ? parseFloat(t) : t),
    Li = (t) => "number" == typeof t || st.test(t);
  function ki(t, e) {
    return void 0 !== t[e] ? t[e] : t.borderRadius;
  }
  const Bi = Fi(0, 0.5, We),
    ji = Fi(0.5, 0.95, Ut);
  function Fi(t, e, n) {
    return (s) => (s < t ? 0 : s > e ? 1 : n(bn(t, e, s)));
  }
  function Oi(t, e) {
  ...
  function Ui(t, e, n, s, i) {
    return (
      (t = pi((t -= e), 1 / n, s)),
      void 0 !== i && (t = pi(t, 1 / i, s)),
      t
    );
  }
  function Ni(t, e, [n, s, i], r, o) {
    !(function (t, e = 0, n = 1, s = 0.5, i, r = t, o = t) {
      if (nt.test(e)) {
        e = parseFloat(e);
        e = nn(o.min, o.max, e / 100) - o.min;
      }
      if ("number" != typeof e) return;
      let a = nn(r.min, r.max, s);
      (t === r && (a -= e),
        (t.min = Ui(t.min, e, n, a, i)),
        (t.max = Ui(t.max, e, n, a, i)));
    })(t, e[n], e[s], e[i], e.scale, r, o);
  }
  const Wi = ["x", "scaleX", "originX"],
    zi = ["y", "scaleY", "originY"];
  function Hi(t, e, n, s) {
    (Ni(t.x, e, Wi, n ? n.x : void 0, s ? s.x : void 0),
      Ni(t.y, e, zi, n ? n.y : void 0, s ? s.y : void 0));
  }
  function $i(t) {
  ...
  class qi {
    ...
    add(t) {
      (hs(this.members, t), t.scheduleRender());
    }
    remove(t) {
      if (
        (ds(this.members, t),
  ...
  class _i {
    ...
    forEach(t) {
      (this.isDirty && this.children.sort(Ki),
        (this.isDirty = !1),
  ...
  function Qi(t, e) {
    ...
    return (zt.read(s, !0), () => Ht(s));
  }
  function tr(t, e, n) {
    var s;
    if ("string" == typeof t) {
      let i = document;
      (e && (Ee(Boolean(e.current)), (i = e.current)),
        n
          ? ((null !== (s = n[t]) && void 0 !== s) ||
  ...
  function nr(t, e) {
    ...
    return (zt.update(s, !0), () => Ht(s));
  }
  const sr = Hn(() => void 0 !== window.ScrollTimeline);
  class ir {
    constructor(t) {
  ...
  const or = /var\((--[a-zA-Z0-9-_]+),? ?([a-zA-Z0-9 ()%#.,-]+)?\)/;
  function ar(t, e, n = 1) {
    Ee(n <= 4);
  ...
  ((fr.translateX = fr.x), (fr.translateY = fr.y));
  const gr = (t, e, n = {}, s = {}) => {
    ((e = { ...e }), (s = { ...s }));
    ...
    if (
      ...
      return (
        ...
        t.render(),
        c && null !== n && window.scrollTo({ top: n }),
  ...
  const vr = (t, e, n, s) => {
      const i = (function (t, { ...e }, n) {
        ...
        for (const t in e) {
          ...
          if (!H(i)) continue;
          const r = ar(i, s);
          r && ((e[t] = r), n || (n = {}), void 0 === n[t] && (n[t] = i));
        }
        return { target: e, transitionEnd: n };
      })(t, e, s);
      return yr(t, (e = i.target), n, (s = i.transitionEnd));
    },
    xr = { current: null },
    Pr = { current: !1 };
  function wr() {
  ...
  class Ar {
    constructor(
      ...
      const { willChange: l, ...c } = this.scrapeMotionValuesFromProps(e, {});
      for (const t in c) {
        const e = c[t];
        void 0 !== o[t] && O(e) && (e.set(o[t], !1), cs(l) && l.add(t));
      }
    }
      ...
      const n = j.has(t),
        s = e.on("change", (e) => {
          ((this.latestValues[t] = e),
            this.props.onUpdate && zt.update(this.notifyUpdate, !1, !0),
    ...
    loadFeatures({ children: t, ...e }, n, s, i) {
      ...
      if (!this.projection && r) {
        ...
        this.projection.setOptions({
          layoutId: t,
          layout: n,
          alwaysMeasureLayout: Boolean(s) || (o && d(o)),
          visualElement: this,
    ...
    update(t, e) {
      ...
      ((this.prevMotionValues = (function (t, e, n) {
        ...
        for (const i in e) {
          const r = e[i],
            o = n[i];
          if (O(r)) (t.addValue(i, r), cs(s) && s.add(i));
          else if (O(o))
            (t.addValue(i, gs(r, { owner: t })), cs(s) && s.remove(i));
          else if (o !== r)
            if (t.hasValue(i)) {
              ...
              t.addValue(i, gs(void 0 !== e ? e : r, { owner: t }));
            }
        }
    ...
    getValue(t, e) {
      ...
      return (
        void 0 === n &&
          void 0 !== e &&
          ((n = gs(e, { owner: this })), this.addValue(t, n)),
        n
      );
    }
    readValue(t) {
  ...
  class Cr extends Ar {
    ...
    makeTargetAnimatableFromInstance(
      ...
      let r = As(n, t || {}, this);
      if ((s && (e && (e = s(e)), n && (n = s(n)), r && (r = s(r))), i)) {
        Ss(this, n, r);
        const t = vr(this, n, r, e);
  ...
  function Dr(t) {
    const e = {
      ...
      n = rr(t)
        ? new Vr(e, { enableHardwareAcceleration: !1 })
        : new Mr(e, { enableHardwareAcceleration: !0 });
    (n.mount(t), er.set(t, n));
  }
  function Rr(t, e, n) {
    const s = O(t) ? t : gs(t);
  ...
  function jr(t, e) {
    return Oe(t) ? t[Br(0, t.length, e)] : t;
  }
  function Fr(t, e, n, s, i, r) {
    !(function (t, e, n) {
      for (let s = 0; s < t.length; s++) {
        const i = t[s];
        i.at > e && i.at < n && (ds(t, i), s--);
      }
    })(t, i, r);
    for (let o = 0; o < e.length; o++)
      t.push({ value: e[o], at: nn(i, r, s[o]), easing: jr(n, o) });
  }
  function Or(t, e) {
    return t.at === e.at
      ? null === t.value
  ...
  function $r(t, e, n, s) {
    ...
    for (let t = 0; t < r; t++) {
      ...
      const a = er.get(s),
        l = { ...n };
      ("function" == typeof l.delay && (l.delay = l.delay(t, r)),
        o.push(...Vs(a, { ...e, transition: l }, {})));
    }
    return new ir(o);
  }
  function Yr(t, e, n) {
    ...
    return (
      (function (t, { defaultTransition: e = {}, ...n } = {}, s) {
        ...
        for (let n = 0; n < t.length; n++) {
          ...
          if (!Array.isArray(r)) {
            l.set(r.name, kr(u, r.at, c, l));
            continue;
          }
          let [d, m, p = {}] = r;
          void 0 !== p.at && (u = kr(u, p.at, c, l));
          let f = 0;
          const g = (t, n, s, r = 0, o = 0) => {
            const a = Nr(t),
              {
                delay: l = 0,
                times: c = Vn(a),
            ...
            const y = "function" == typeof l ? l(r, o) : l,
              v = a.length;
            if (v <= 2 && "spring" === d) {
              let t = 100;
              if (2 === v && Hr(a)) {
          ...
          if (O(d)) {
            ...
            for (let n = 0; n < e; n++) {
              ((m = m), (p = p));
              const s = Ir(t[n], o);
              for (const t in m) g(m[t], Wr(p, t), Ur(t, s), n, e);
            }
            ((c = u), (u += f));
          }
        }
          ...
          o.forEach((t, s) => {
            for (const i in t) {
              ...
              for (let t = 0; t < o.length; t++) {
                ...
                (a.push(n), l.push(bn(0, h, e)), c.push(s || "easeOut"));
              }
              (0 !== l[0] &&
                (l.unshift(0), a.unshift(a[0]), c.unshift("easeInOut")),
                1 !== l[l.length - 1] && (l.push(1), a.push(null)),
                r.has(s) || r.set(s, { keyframes: {}, transition: {} }));
              const u = r.get(s);
              ((u.keyframes[i] = a),
                (u.transition[i] = {
                  ...e,
        ...
        let i;
        ((i = O(n) ? Rr(n, t.default, e.default) : $r(n, t, e)), s.push(i));
      }),
      new ir(s)
    );
  }
  const Xr = (t) =>
    ...
    qr = new WeakMap();
  let Zr;
  function Kr({ target: t, contentRect: e, borderBoxSize: n }) {
    var s;
    null === (s = qr.get(t)) ||
      void 0 === s ||
      s.forEach((s) => {
  ...
  function Jr(t, e) {
    Zr ||
      ("undefined" != typeof ResizeObserver && (Zr = new ResizeObserver(_r)));
    const n = tr(t);
    return (
      n.forEach((t) => {
        let n = qr.get(t);
        (n || ((n = new Set()), qr.set(t, n)),
          n.add(e),
          null == Zr || Zr.observe(t));
      }),
      () => {
        n.forEach((t) => {
          const n = qr.get(t);
          (null == n || n.delete(e),
            (null == n ? void 0 : n.size) || null == Zr || Zr.unobserve(t));
        });
      }
    );
  }
  ...
  function eo(t) {
    return (
      ...
      () => {
        (Qr.delete(t), !Qr.size && to && (to = void 0));
      }
    );
  }
  const no = {
  ...
  function so(t, e, n, s) {
    ...
    const c = s - l;
    i.velocity = c > 50 ? 0 : Dn(i.current - a, c);
  }
  const io = {
      Enter: [
        [0, 1],
    ...
    ro = { start: 0, center: 0.5, end: 1 };
  function oo(t, e, n = 0) {
    let s = 0;
    if ((void 0 !== ro[t] && (t = ro[t]), "string" == typeof t)) {
  ...
  const co = { x: 0, y: 0 };
  function uo(t, e, n) {
    let { offset: s = io.All } = n;
    const { target: i = t, axis: r = "y" } = n,
      o = "y" === r ? "height" : "width",
      a =
        i !== t
          ? (function (t, e) {
    ...
    const h = s.length;
    for (let t = 0; t < h; t++) {
      const n = lo(s[t], c[o], l[o], a[r]);
      (u || n === e[r].interpolatorOffsets[t] || (u = !0),
        (e[r].offset[t] = n));
    }
    (u &&
      ((e[r].interpolate = An(e[r].offset, Vn(s))),
  ...
  function ho(t, e, n, s = {}) {
    return {
      ...
      update: (e) => {
        (!(function (t, e, n) {
          (so(t, "x", e, n), so(t, "y", e, n), (e.time = n));
        })(t, n, e),
          (s.offset || s.target) && uo(t, n, s));
      },
      notify: () => e(n),
    };
  }
  const mo = new WeakMap(),
    po = new WeakMap(),
    fo = new WeakMap(),
    go = (t) => (t === document.documentElement ? window : t);
  function yo(t, { container: e = document.documentElement, ...n } = {}) {
    let s = fo.get(e);
    s || ((s = new Set()), fo.set(e, s));
    const i = ho(
      e,
      t,
      {
    ...
    if ((s.add(i), !mo.has(e))) {
      const t = () => {
        ...
        n = () => {
          for (const t of s) t.update($t.timestamp);
        },
        i = () => {
          for (const t of s) t.notify();
        },
        a = () => {
          (zt.read(t, !1, !0), zt.update(n, !1, !0), zt.update(i, !1, !0));
        };
      mo.set(e, a);
      const l = go(e);
      (window.addEventListener("resize", a, { passive: !0 }),
        e !== document.documentElement &&
          po.set(e, ((o = a), "function" == typeof (r = e) ? eo(r) : Jr(r, o))),
    ...
    return (
      ...
      () => {
        ...
        (mo.delete(e),
          s &&
            (go(e).removeEventListener("scroll", s),
            null === (t = po.get(e)) || void 0 === t || t(),
            window.removeEventListener("resize", s)));
      }
    );
  }
  const vo = new Map();
  function xo({ source: t = document.documentElement, axis: e = "y" } = {}) {
    vo.has(t) || vo.set(t, {});
    const n = vo.get(t);
    return (
      n[e] ||
  ...
  const Po = { some: 0, all: 1 };
  function wo(t, e, { root: n, margin: s, amount: i = "some" } = {}) {
    const r = tr(t),
      o = new WeakMap(),
      a = new IntersectionObserver(
        ...
        { root: n, rootMargin: s, threshold: "number" == typeof i ? i : Po[i] },
      );
  ...
  function Vo({
    ...
    return class {
      constructor(t = {}, n = null == e ? void 0 : e()) {
        ((this.id = Ao++),
          ...
          (this.updateProjection = () => {
            var t;
            ((Co.totalNodes =
              Co.resolvedTargetDeltas =
              Co.recalculatedProjection =
                0),
        ...
        this.root === this && (this.nodes = new _i());
      }
      addEventListener(t, e) {
        return (
          this.eventHandlers.has(t) || this.eventHandlers.set(t, new ms()),
      ...
      mount(e, n = this.root.hasTreeAnimated) {
        ...
        ((this.isSVG = rr(e)), (this.instance = e));
        const { layoutId: s, layout: i, visualElement: r } = this.options;
        if (
          ...
          t(e, () => {
            ((this.root.updateBlockedByResize = !0),
              ...
              Ji.hasAnimatedSinceResize &&
                ((Ji.hasAnimatedSinceResize = !1), this.nodes.forEach(Oo)));
          });
        }
          ...
          !1 !== this.options.animate &&
            ...
            this.addEventListener(
              ...
              ({
                ...
                const i =
                    this.options.transition || r.getDefaultTransition() || Yo,
                  { onLayoutAnimationStart: o, onLayoutAnimationComplete: a } =
                    r.getProps(),
                  l = !this.targetLayout || !Xi(this.targetLayout, s) || n,
                  c = !e && n;
                if (
                  ...
                  const e = { ...as(i, "layout"), onPlay: o, onComplete: a };
      ...
      update() {
        ...
        (this.isUpdating || this.nodes.forEach(jo),
          (this.isUpdating = !1),
        ...
        (($t.delta = Y(0, 1e3 / 60, t - $t.timestamp)),
          ($t.timestamp = t),
          ($t.isProcessing = !0),
          Yt.update.process($t),
          Yt.preRender.process($t),
          Yt.render.process($t),
          ($t.isProcessing = !1));
      }
      didUpdate() {
      ...
      clearAllSnapshots() {
        (this.nodes.forEach(ko), this.sharedNodes.forEach(Wo));
      }
      ...
      resetTransform() {
        ...
        const t = this.isLayoutDirty || this.shouldResetTransform,
          e = this.projectionDelta && !Yi(this.projectionDelta),
          n = this.getTransformTemplate(),
          s = n ? n(this.latestValues, "") : void 0,
          r = s !== this.prevTransformTemplateValue;
        t &&
          (e || hi(this.latestValues) || r) &&
          (i(this.instance, s),
          (this.shouldResetTransform = !1),
          this.scheduleRender());
      }
      ...
      applyTransform(t, e = !1) {
        ...
        for (let t = 0; t < this.path.length; t++) {
          ...
          (!e &&
            ...
            s.scroll &&
            s !== s.root &&
            bi(n, { x: -s.scroll.offset.x, y: -s.scroll.offset.y }),
            hi(s.latestValues) && bi(n, s.latestValues));
        }
        return (hi(this.latestValues) && bi(n, this.latestValues), n);
      }
      removeTransform(t) {
        const e = { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } };
        Ii(e, t);
        ...
        return (hi(this.latestValues) && Hi(e, this.latestValues), e);
      }
      setTargetDelta(t) {
        ((this.targetDelta = t),
      ...
      resolveTargetDelta(t = !1) {
        ...
        if (
          ...
          return;
        const { layout: i, layoutId: r } = this.options;
        if (this.layout && (i || r)) {
          if (
            ...
            t && t.layout && 1 !== this.animationProgress
              ? ((this.relativeParent = t),
                ...
                Ii(this.relativeTarget, this.relativeTargetOrigin))
              ...
              this.relativeParent.target
                ...
                : this.targetDelta
                  ? (this.resumingFrom
                      ...
                      : Ii(this.target, this.layout.layoutBox),
      ...
      calcProjection() {
        ...
        if (
          ...
          n &&
            ...
            (s = !1),
          this.resolvedRelativeTargetAt === $t.timestamp && (s = !1),
          s)
        )
          return;
        const { layout: i, layoutId: r } = this.options;
          ...
          for (let a = 0; a < i; a++) {
            ...
            (i && i.style && "contents" === i.style.display) ||
              (s &&
                ...
                r.scroll &&
                r !== r.root &&
                bi(t, { x: -r.scroll.offset.x, y: -r.scroll.offset.y }),
              o && ((e.x *= o.x.scale), (e.y *= o.y.scale), yi(t, o)),
              s && hi(r.latestValues) && bi(t, r.latestValues));
          }
          ((e.x = vi(e.x)), (e.y = vi(e.y)));
        ...
        (_s(this.projectionDelta, this.layoutCorrected, l, this.latestValues),
          (this.projectionTransform = Zi(this.projectionDelta, this.treeScale)),
      ...
      setAnimationOrigin(t, e = !1) {
        ...
        const o = { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } },
          ...
          u = Boolean(
            a && !c && !0 === this.options.crossfade && !this.path.some($o),
          );
        let h;
        ((this.animationProgress = 0),
              ...
              a &&
                ...
                (function (t, e, n, s, i, r) {
                  ...
                  for (let i = 0; i < Di; i++) {
                    ...
                    (o || (o = 0), a || (a = 0));
                    0 === o || 0 === a || Li(o) === Li(a)
                      ? ((t[r] = Math.max(nn(Ri(o), Ri(a), s), 0)),
                        (nt.test(a) || nt.test(o)) && (t[r] += "%"))
                      : (t[r] = a);
                  }
                  (e.rotate || n.rotate) &&
                    (t.rotate = nn(e.rotate || 0, n.rotate || 0, s));
        ...
        (this.notifyListeners("animationStart"),
          ...
          (this.pendingAnimation = zt.update(() => {
            ((Ji.hasAnimatedSinceResize = !0),
              (this.currentAnimation = Rr(0, 1e3, {
                ...t,
                onUpdate: (e) => {
      ...
      applyTransformsToTarget() {
        ...
        if (e && n && s) {
          if (
            ...
            this.layout &&
            s &&
            Zo(this.options.animationType, this.layout.layoutBox, s.layoutBox)
          ) {
            n = this.target || { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } };
            const e = qs(this.layout.layoutBox.x);
            ((n.x.min = t.target.x.min), (n.x.max = n.x.min + e));
            const s = qs(this.layout.layoutBox.y);
            ((n.y.min = t.target.y.min), (n.y.max = n.y.min + s));
          }
          (Ii(e, n),
            bi(e, i),
            _s(this.projectionDeltaWithTransform, this.layoutCorrected, e, i));
        }
      }
      registerSharedNode(t, e) {
        this.sharedNodes.has(t) || this.sharedNodes.set(t, new qi());
      ...
      getProjectionStyles(t = {}) {
        ...
        for (const t in L) {
          ...
          const { correct: e, applyTo: n } = L[t],
            i = "none" === s.transform ? o[t] : e(o[t], r);
          if (n) {
            const t = n.length;
        ...
        return (
          this.options.layoutId &&
            (s.pointerEvents = r === this ? Ft(t.pointerEvents) || "" : "none"),
          s
        );
      }
      clearSnapshot() {
  ...
  function Do(t) {
    ...
    if (t.isLead() && t.layout && n && t.hasListeners("didUpdate")) {
      ...
      "size" === i
        ...
        : Zo(i, n.layoutBox, e) &&
          ai((s) => {
            const i = r ? n.measuredBox[s] : n.layoutBox[s],
              o = qs(e[s]);
            ((i.max = i.min + o),
              t.relativeTarget &&
                !t.currentAnimation &&
      ...
      r ? _s(a, t.applyTransform(s, !0), n.measuredBox) : _s(a, e, n.layoutBox);
      const l = !Yi(o);
      let c = !1;
      if (!t.resumeFrom) {
        const s = t.getClosestProjectingParent();
        if (s && !s.resumeFrom) {
          const { snapshot: i, layout: r } = s;
          if (i && r) {
            const o = { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } };
            ti(o, n.layoutBox, i.layoutBox);
  ...
  const Yo = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
    ...
    Go = Xo("applewebkit/") && !Xo("chrome/") ? Math.round : Ut;
  function qo(t) {
    ((t.min = Go(t.min)), (t.max = Go(t.max)));
  }
  function Zo(t, e, n) {
    return (
      "position" === t || ("preserve-aspect" === t && !Zs(Gi(e), Gi(n), 0.2))
    );
  }
  const Ko = Vo({
    ...
    Qo = (t) => !t.isLayoutDirty && t.willUpdate(!1);
  function ta() {
    const t = new Set(),
      e = new WeakMap(),
      n = () => t.forEach(Qo);
  ...
  const na = {
      correct: (t, e) => {
        ...
        return `${ea(t, e.target.x)}% ${ea(t, e.target.y)}%`;
      },
    },
    sa = {
      correct: (t, { treeScale: e, projectionDelta: n }) => {
        ...
        const c = nn(a, l, 0.5);
        return (
          "number" == typeof i[2 + o] && (i[2 + o] /= c),
          "number" == typeof i[3 + o] && (i[3 + o] /= c),
          r(i)
        );
      },
    };
  function ia() {
    ...
    const { isPresent: n, onExitComplete: s, register: i } = t,
      r = e.useId();
    e.useEffect(() => i(r), []);
    return !n && s ? [!1, () => s && s(r)] : [!0];
  }
  class ra extends r.default.Component {
    componentDidMount() {
      const {
          visualElement: t,
          layoutGroup: e,
  ...
  function oa(t) {
    const [n, s] = ia(),
      i = e.useContext(S);
    return r.default.createElement(ra, {
      ...t,
      layoutGroup: i,
      switchLayoutGroup: e.useContext(T),
      isPresent: n,
      safeToRemove: s,
    });
  }
  const aa = {
    ...
    ca = (t, e) =>
      R(t)
        ? new Vr(e, { enableHardwareAcceleration: !1 })
        : new Mr(e, { enableHardwareAcceleration: !0 }),
    ua = { layout: { ProjectionNode: Jo, MeasureLayout: oa } },
    ha = { ...Is, ...ye, ...la, ...ua },
    da = M((t, e) => qt(t, e, ha, ca));
  const ma = M(qt);
  function pa() {
    const t = e.useRef(!1);
    return (
  ...
  function fa() {
    ...
    return [e.useCallback(() => zt.postRender(i), [i]), n];
  }
  ...
  function ya({ children: t, isPresent: n }) {
    const s = e.useId(),
      r = e.useRef(null),
      o = e.useRef({ width: 0, height: 0, top: 0, left: 0 });
    return (
      e.useInsertionEffect(() => {
        const { width: t, height: e, top: i, left: a } = o.current;
      ...
      i.createElement(
        ga,
        { isPresent: n, childRef: r, sizeRef: o },
  ...
  const va = ({
    ...
    return (
      ...
      "popLayout" === c && (t = i.createElement(ya, { isPresent: s }, t)),
  ...
  const ba = e.createContext(null),
    Sa = (t) => !0 === t,
    Ta = ({ children: t, id: n, inherit: s = !0 }) => {
      ...
      null === c.current &&
        (((t) => Sa(!0 === t) || "id" === t)(s) &&
          u &&
          (n = n ? u + "-" + n : u),
        (c.current = { id: n, group: (Sa(s) && r.group) || ta() }));
      const h = e.useMemo(() => ({ ...c.current, forceRender: a }), [l]);
  ...
  function Ra(t, e, n, s) {
    if ("function" == typeof t)
      return (function (t) {
        ((ps.current = []), t());
        const e = Da(ps.current, t);
        return ((ps.current = void 0), e);
      })(t);
    const i = "function" == typeof e ? e : Eo(e, n, s);
  ...
  const Ba = {
      Group: e.forwardRef(function (
        ...
        const d = {
          ...
          registerItem: (t, e) => {
            e &&
              -1 === u.findIndex((e) => t === e.value) &&
              (u.push({ value: t, layout: e[s] }), u.sort(Va));
          },
          updateOrder: (t, e, n) => {
            if (h.current) return;
            const s = (function (t, e, n, s) {
              ...
              const a = t[i],
                l = o.layout,
                c = nn(l.min, l.max, 0.5);
              return (1 === r && a.layout.max + n > c) ||
                (-1 === r && a.layout.min + n < c)
                ? (function ([...t], e, n) {
            ...
            u !== s &&
              ((h.current = !0),
              r(s.map(Ca).filter((t) => -1 !== o.indexOf(t))));
          },
        };
        return (
          e.useEffect(() => {
    ...
    ja = { renderer: ca, ...Is, ...ye },
    Fa = { ...ja, ...la, ...ua };
  function Oa(t, n, s) {
    e.useInsertionEffect(() => t.on(n, s), [t, n, s]);
  }
  function Ia(t, e) {
    we(Boolean(!e || e.current));
  }
  const Ua = () => ({
    scrollX: gs(0),
    scrollY: gs(0),
    scrollXProgress: gs(0),
    scrollYProgress: gs(0),
  });
  function Na({ container: t, target: n, layoutEffect: s = !0, ...i } = {}) {
    const r = Bt(Ua);
    return (
      (s ? u : e.useEffect)(
        () => (
          ...
          yo(
            ({ x: t, y: e }) => {
              (r.scrollX.set(t.current),
                ...
                r.scrollY.set(e.current),
                r.scrollYProgress.set(e.progress));
            },
            {
              ...i,
  ...
  class za extends fs {
    ...
    add(t) {
      ...
      (j.has(t)
        ...
        e && (hs(this.members, e), this.update()));
    }
    remove(t) {
      (j.has(t)
        ? (this.transforms.delete(t),
          this.transforms.size || ds(this.members, "transform"))
        : ds(this.members, Ct(t)),
        this.update());
    }
    update() {
    ...
    const e = new Set(),
      n = {
        ...
        start(n, s) {
          ...
          return (
            e.forEach((t) => {
              i.push(Rs(t, n, { transitionOverride: s }));
            }),
            Promise.all(i)
          );
        },
  ...
  class Ga {
    ...
    subscribe(t) {
      return (
        ...
        () => this.componentControls.delete(t)
      );
    }
    start(t, e) {
  ...
  function _a(t) {
    _o.current &&
      ((_o.current.isUpdating = !1), _o.current.blockUpdate(), t && t());
  }
  const Ja = (t, e) => `${t}: ${e}`,
    Qa = new Map();
  function tl(t, e, n, s) {
    const i = Ja(t, j.has(e) ? "transform" : e),
      r = Qa.get(i);
    if (!r) return 0;
  ...
  class nl extends Ar {
    ...
    makeTargetAnimatableFromInstance({
      ...
      return (
        Ss(this, n, As(n, t || {}, this)),
        { transition: t, transitionEnd: e, ...n }
      );
    }
  }
  const sl = Ot({ scrapeMotionValuesFromProps: el, createRenderState: el });
  const il = (t) => (t > 0.001 ? 1 / t : 1e5);
  let rl = !1;
  let ol = 0;
  ((t.AnimatePresence = ({
    children: t,
    ...
    Ee(!o);
    const c = e.useContext(S).forceRender || fa()[0],
      h = pa(),
      d = (function (t) {
        const n = [];
        return (
    ...
    return (
      ...
      p.forEach((t, e) => {
        ...
        if (!u) {
          const t = () => {
            (g.delete(e), p.delete(e));
            const t = f.current.findIndex((t) => t.key === e);
      ...
      (m = m.map((t) => {
        ...
        return p.has(e)
          ...
          : i.createElement(
              va,
              { key: wa(t), isPresent: !0, presenceAffectsLayout: a, mode: l },
              t,
            );
      })),
      i.createElement(
    ...
    (t.AnimateSharedLayout = ({ children: t }) => (
      ...
      i.createElement(Ta, { id: Bt(() => "asl-" + ol++) }, t)
    )),
    (t.DeprecatedLayoutGroupContext = ba),
    (t.DragControls = Ga),
    (t.FlatTree = _i),
    (t.LayoutGroup = Ta),
    (t.LayoutGroupContext = S),
    (t.LazyMotion = function ({ children: t, features: n, strict: s = !1 }) {
      const [, r] = e.useState(!Ea(n)),
        o = e.useRef(void 0);
      if (!Ea(n)) {
      ...
      return (
        ...
        i.createElement(
          h.Provider,
          { value: { renderer: o.current, strict: s } },
          t,
        )
      );
    }),
    (t.MotionConfig = function ({ children: t, isValidProp: n, ...s }) {
      (n && yt(n),
        ((s = { ...e.useContext(o), ...s }).isStatic = Bt(() => s.isStatic)));
      const r = e.useMemo(
        () => s,
        [JSON.stringify(s.transition), s.transformPagePoint, s.reducedMotion],
      );
      return i.createElement(o.Provider, { value: r }, t);
    }),
    (t.MotionConfigContext = o),
    (t.MotionContext = a),
    (t.MotionValue = fs),
    (t.PresenceContext = l),
    (t.Reorder = Ba),
    (t.SwitchLayoutGroupContext = T),
    (t.VisualElement = Ar),
    (t.addPointerEvent = Qt),
    (t.addPointerInfo = Jt),
    (t.addScaleCorrector = k),
    (t.animate = Gr),
    (t.animateValue = zn),
    (t.animateVisualElement = Rs),
    (t.animationControls = $a),
    (t.animations = Is),
    (t.anticipate = Xe),
    (t.backIn = $e),
    (t.backInOut = Ye),
    ...
    (t.createDomMotionComponent = function (t) {
      return C(qt(t, { forwardMotionProps: !1 }, ha, ca));
    }),
    (t.createMotionComponent = C),
    (t.createScopedAnimate = Xr),
    (t.cubicBezier = ke),
    (t.delay = Qi),
    (t.distance = Us),
    (t.distance2D = Ns),
    ...
    (t.motion = da),
    (t.motionValue = gs),
    (t.optimizedAppearDataAttribute = Pe),
    (t.pipe = ee),
    (t.progress = bn),
    (t.px = st),
    ...
    (t.scroll = function (t, e) {
      const n = xo(e);
      return "function" == typeof t ? nr(t, n) : t.attachTimeline(n);
    }),
    (t.scrollInfo = yo),
    (t.spring = On),
    (t.stagger = function (
    ...
    (t.startOptimizedAppearAnimation = function (t, e, n, s, i) {
      const r = t.dataset.framerAppearId;
      if (!r) return;
      window.HandoffAppearAnimations = tl;
      const o = Ja(r, e),
        a = Re(t, e, [n[0], n[0]], { duration: 1e4, ease: "linear" });
      Qa.set(o, { animation: a, startTime: null });
      const l = () => {
        a.cancel();
        const r = Re(t, e, n, s);
        (document.timeline && (r.startTime = document.timeline.currentTime),
          Qa.set(o, { animation: r, startTime: performance.now() }),
          i && i(r));
      };
    ...
    (t.useCycle = function (...t) {
      ...
      return [
        ...
        e.useCallback(
          (e) => {
            ((n.current =
              "number" != typeof e ? Br(0, t.length, n.current + 1) : e),
              i(t[n.current]));
          },
          [t.length, ...t],
        ),
    ...
    (t.useDeprecatedAnimatedState = function (t) {
      ...
      return (
        e.useEffect(() => (r.mount({}), () => r.unmount()), [r]),
        e.useEffect(() => {
          r.update(
            {
              onUpdate: (t) => {
    ...
    (t.useDeprecatedInvertedScale = function (t) {
      ...
      return (
        ...
        { scaleX: Ra(n, il), scaleY: Ra(s, il) }
      );
    }),
    (t.useDomEvent = function (t, n, s, i) {
      e.useEffect(() => {
        const e = t.current;
        if (s && e) return Zt(e, n, s, i);
      }, [t, n, s, i]);
    }),
    ...
    (t.useElementScroll = function (t) {
      return Na({ container: t });
    }),
    (t.useForceUpdate = fa),
    (t.useInView = function (
      t,
      { root: n, margin: s, amount: i, once: r = !1 } = {},
    ) {
      const [o, a] = e.useState(!1);
      return (
        e.useEffect(() => {
          if (!t.current || (r && o)) return;
          const e = { root: (n && n.current) || void 0, margin: s, amount: i };
          return wo(t.current, () => (a(!0), r ? void 0 : () => a(!1)), e);
        }, [n, t, s, r]),
        o
      );
    }),
    (t.useInstantLayoutTransition = Ka),
    (t.useInstantTransition = function () {
      ...
      return (
        e.useEffect(() => {
          zt.postRender(() =>
            zt.postRender(() => {
              n === i.current && (Te.current = !1);
            }),
          );
        }, [n]),
        (e) => {
          s(() => {
            ((Te.current = !0), t(), e(), (i.current = n + 1));
          });
        }
      );
    }),
    ...
    (t.useIsomorphicLayoutEffect = u),
    (t.useMotionTemplate = function (t, ...e) {
      const n = t.length;
      return Da(e.filter(O), function () {
        let s = "";
        for (let i = 0; i < n; i++) {
          s += t[i];
          const n = e[i];
    ...
    (t.useMotionValue = Ma),
    (t.useMotionValueEvent = Oa),
    (t.usePresence = ia),
    (t.useReducedMotion = Ha),
    (t.useReducedMotionConfig = function () {
      const t = Ha(),
        { reducedMotion: n } = e.useContext(o);
    ...
    (t.useSpring = function (t, n = {}) {
      const { isStatic: s } = e.useContext(o),
        i = e.useRef(null),
        r = Ma(O(t) ? t.get() : t),
        a = () => {
      ...
      return (
          ...
          () =>
            r.attach((t, e) => {
              ...
              if (
                ...
                const t = performance.now() - $t.timestamp;
                t < 30 && (i.current.time = Se(t));
              }
              return r.get();
            }, a),
          [JSON.stringify(n)],
        ...
        u(() => {
          if (O(t)) return t.on("change", (t) => r.set(parseFloat(t)));
        }, [r]),
        r
      );
    }),
    ...
    (t.useTransform = Ra),
    (t.useUnmountEffect = Pa),
    (t.useVelocity = function (t) {
      const e = Ma(t.getVelocity());
      return (
        Oa(t, "velocityChange", (t) => {
          e.set(t);
        }),
        e
      );
    ...
    (t.useWillChange = function () {
      return Bt(() => new za("auto"));
    }),
    (t.visualElementStore = er),
    (t.warning = we),
    (t.wrap = Br),
